        ...
        this.router.params.subscribe(params => {
            if (params['id']) {
                this.filmesService.buscarFilme(params['id']).subscribe({
                    ...
                    error: err => {
                        this.toastService.showToastBottomCenter(err.error.errpr || 'Erro ao buscar filme');
                    },
                });
            }
        });
    ...
    cadastrarFilme() {
      if (this.formFilme.valid) {
          ...
          this.filmesService.cadastrarFilme(this.formFilme.value).subscribe({
              ...
              error: err => {
                  this.toastService.showToastBottomCenter(err.error.errpr || 'Erro ao cadastrar filme');
                  this.loading = false;
              },
          });
      }
